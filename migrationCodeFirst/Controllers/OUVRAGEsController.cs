...
namespace migrationCodeFirst.Controllers
{
    public class OUVRAGEsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NUMOUVR,NOMOUVR,ANNEEPARU,NUMRUB,NOMED,NUMCAT")] OUVRAGE oUVRAGE)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NUMOUVR,NOMOUVR,ANNEEPARU,NUMRUB,NOMED,NUMCAT")] OUVRAGE oUVRAGE)
        {
            if (ModelState.IsValid)
            {
